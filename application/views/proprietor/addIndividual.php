  ...
  <div class="col-lg-10">
    <div class="element-wrapper">
      <h6 class="element-header">
        Add Individual Resident
      </h6>
      <div class="element-box">
        <form method="post" action="<?php echo base_url('index.php/proprietor/addIndividual');?>">
          <div class="form-desc">
            <?php echo $name; ?>
            Kindly NOTE that below fields are all mandatory and are used only when entering individual resident
            <?php if(isset($message)){?><br><h5><strong><?php } echo $message;?></strong></h5>
          </div>
          <div class="row">
            <div class="col-sm-6">
              <div class="form-group">
                <label for=""> First Name </label><input class="form-control" placeholder="Enter First Name" type="text" required="" name="f_name">
              </div>
            </div>
            <div class="col-sm-6">
              <div class="form-group">
                <label for=""> Last Name </label><input class="form-control" placeholder="Enter Last Name" type="text" required="" name="l_name">
              </div>
            </div>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <input class="form-control" placeholder="Enter ID/Huduma Number" type="number" required="" name="n_id">
