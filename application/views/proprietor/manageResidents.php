              ...
              <div class="element-wrapper">
                ...
                <div class="element-box">
                  <h6 class="form-header">
                    <small>Below Select a filter of your choice i.e. status, date or leave blank to fetch all residents. You can use the search box above the table to filter results by typing the status or name or anything. It's a universal search form</small>
                  </h6>
                    <div class="row">
                      <div class="col-sm-2">
                        <div class="form-group">
                          <?php echo form_open('proprietor/manageResidents');?>
                      ...
                      <div class="col-sm-3">
                        <div class="form-group">
                          <input type="date" name="date1" placeholder="From...." class="form-control" title="From...">
                        </div>
                      </div>
                      <div class="col-sm-3">
                        <div class="form-group">
                          <input type="date" name="date2" placeholder="To...." class="form-control" title="To....">
                        </div>
                      </div>
                      <div class="col-sm-2">
                        <div class="form-group">
                  ...
                  <div class="form-desc">
                    All your tenants (residents) who are in <?php echo $selected_status; ?> state <?php echo $dates; ?> are listed below
                  </div>
                  <div class="table-responsive">
                    <table id="active" width="100%" class="table table-striped table-lightfont">
                      <thead>
                        <tr>
                          <th>Name</th><th>House</th><th>Phone</th><th>Type</th><th>Added by</th><th>Date</th><th>Status</th><th>Action</th>
                        </tr>
                      </thead>
                      <tfoot>
                        <tr>
                      ...
                      <tbody>
                        <?php foreach ($residents as $residents) {?>
                          <tr>
                            <td><?php echo $residents->res_f_name." ".$residents->res_l_name;?></td>
                            <td>Pending Allocation</td>
                            <td><?php echo $residents->res_phone;?></td>
                            <td><?php echo $residents->res_type;?></td>
                            <td><?php echo $residents->res_added_by;?></td>
                            <td><?php echo date('d/m/Y H:i', strtotime($residents->res_added_on));?></td>
                            <td><?php echo $residents->res_status;?></td>
                            <td><?php echo form_open('proprietor/manageResidents'); echo form_hidden('man_res_email',$residents->res_n_id);echo form_hidden('nothing','nothing_part'); echo form_submit('submit','Manage','btn-danger btn-sm'); echo form_close(); ?></td>
                          </tr>
                        <?php } ?>                        
                      </tbody>
                    </table>
