                    ...
                    <table id="active" width="100%" class="table table-striped table-lightfont">
                      ...
                      <tbody>
                        <?php foreach ($custodians as $custodians) {?>
                          <tr>
                            <td><?php echo $custodians->cust_name;?></td>
                            <td><?php echo $custodians->cust_phone;?></td>
                            <td><?php echo $custodians->cust_email;?></td>
                            <td><?php echo $custodians->cust_nid;?></td>
                            <td><a href="<?php echo current_url();?>/<?php echo $custodians->cust_id;?>">Manage</a></td>
                          </tr>
                        <?php } ?>                        
                      </tbody>
                    </table>
